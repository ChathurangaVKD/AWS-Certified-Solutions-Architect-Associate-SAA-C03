...
> **完了時間**: 30-45 分 | **試験配点**: ~10% foundation

## 🎯 必須理解コンセプト (5 Minutes)

### AWS グローバル Infrastructure - The 3 Pillars
```
...
### シナリオ 1: Minimize Latency
**質問**: Users in Europe experience high latency
**Answer**: Deploy in EU region (eu-west-1) + use CloudFront for static content

### シナリオ 2: Ensure High Availability
**質問**: Application must survive data center failure
**Answer**: Deploy across multiple AZs in same region

### シナリオ 3: Disaster Recovery
**質問**: Protect against region-wide failure
**Answer**: Backup/replicate to different region

### シナリオ 4: Data Compliance
**質問**: Data cannot leave country
...
**Exam Tip**: Control Tower = Organizations + Automation + ベストプラクティス
...
**グローバル vs Regional Services:**
- **グローバル**: IAM, CloudFront, Route 53, WAF
...
**Answers**: 1) 3  2) CloudFront/Edge Locations  3) AWS  4) AZs  5) グローバル
